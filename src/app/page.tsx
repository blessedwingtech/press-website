                ...
                {cat.articles.map((article) => (
                  ...
                  >
                    ...
                    <div className="p-4 flex-grow flex flex-col justify-between">
                      <div>
                        <span className="text-[9px] text-slate-500 block mb-1 font-semibold">
                          {new Date(article.datePublication).toLocaleDateString('fr-FR')}
                        </span>
          ...
          <div className="sticky top-20 space-y-6">
            ...
            <div className="bg-gradient-to-br from-slate-900/60 to-slate-950 border border-slate-800 rounded-xl p-5 shadow-lg">
              ...
              <p className="text-[11px] text-slate-450 leading-relaxed font-medium">
                Chronos est une plateforme de presse rédactionnelle généraliste et sportive en temps réel. Nos journalistes fournissent des analyses objectives sur la politique, la santé, le sport, la culture et l'économie mondiale.
              </p>
